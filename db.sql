...
CREATE TABLE IF NOT EXISTS cerebro.ip (id SERIAL PRIMARY KEY, asn_data_id INT, ipv4 TEXT, ipv6 TEXT, hostname TEXT, state TEXT, create_date timestamp, last_update timestamp);
